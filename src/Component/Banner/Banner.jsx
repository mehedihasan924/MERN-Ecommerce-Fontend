                    ...
                    <div className='flex bg-white py-2 px-3 rounded-2xl items-center gap-3 shadow-md w-64'>
                      ...
                      <div className='space-y-1'>
                        ...
                        <div className="rating rating-sm">
                            <input readOnly type="radio" name="rating-2" className="mask mask-star-2 bg-yellow-500" />
                            <input readOnly type="radio" name="rating-2" className="mask mask-star-2 bg-yellow-500" checked />
                            <input readOnly type="radio" name="rating-2" className="mask mask-star-2 bg-yellow-500" />
                            <input readOnly type="radio" name="rating-2" className="mask mask-star-2 bg-yellow-500" />
                            <input readOnly type="radio" name="rating-2" className="mask mask-star-2 bg-yellow-500" />
                        </div>
